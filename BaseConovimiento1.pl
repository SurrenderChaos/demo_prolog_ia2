...
/*Hice un comentario
*/
conocimiento('vendedor',
['compra 20 pantallas cada mes',
 'compra articulos con precios reducidos',
'compra mas de 10 productos baratos a la semana',
'compra mas de 10 productos a la semana',
...
'compra menos de 10 pinturas por mes',
 ...
 'compra articulos de arte de calidad']).